...
OPTIONAL(Null)
OPTIONAL(OptionalNull)

OPTIONAL(OptionalJSONValue);
OPTIONAL(OptionalInt);
OPTIONAL(OptionalInts);
OPTIONAL(OptionalUInt32);
OPTIONAL(OptionalUInt32s);
OPTIONAL(OptionalBool);
OPTIONAL(OptionalStringView);
OPTIONAL(OptionalStringViews);
...
extern OptionalJSONValue          OptionalJSONValue_encode(OptionalJSONValue value);
extern OptionalOptionalJSONValue  OptionalJSONValue_decode(OptionalJSONValue value);
extern OptionalJSONValue          Int_encode(int value);
extern OptionalInt                Int_decode(OptionalJSONValue value);
extern OptionalJSONValue          OptionalInt_encode(OptionalInt value);
extern OptionalOptionalInt        OptionalInt_decode(OptionalJSONValue value);
...
extern OptionalJSONValue          OptionalUInt32_encode(OptionalUInt32 value);
extern OptionalOptionalUInt32     OptionalUInt32_decode(OptionalJSONValue value);
...
extern OptionalJSONValue          OptionalBool_encode(OptionalBool value);
extern OptionalOptionalBool       OptionalBool_decode(OptionalJSONValue value);
...
extern OptionalJSONValue          OptionalStringView_encode(OptionalStringView value);
extern OptionalOptionalStringView OptionalStringView_decode(OptionalJSONValue value);
